  ...
  const sendMessage = async (text: string) => {
    ...
    try {
      ...
      if (requestId === requestIdRef.current) {
        const message = caughtError instanceof Error && caughtError.message ? caughtError.message : "这次回复没有生成成功，请重试。";
        setError(message);
