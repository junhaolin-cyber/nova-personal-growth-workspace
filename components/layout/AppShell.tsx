  ...
  return (
    <div className="min-h-screen bg-canvas text-ink">
      ...
      <div className="lg:pl-[252px]">
        ...
        <main className="h-[calc(100vh-76px)] min-h-[620px] overflow-y-auto overscroll-y-auto px-5 py-8 pb-20 sm:px-8 lg:px-12 lg:py-10">{active === "dashboard" ? <Dashboard locale={locale} /> : active === "today" ? <TodayPlan locale={locale} /> : <ModulePlaceholder slug={active} locale={locale} />}</main>
      </div>
    </div>
  );
}
